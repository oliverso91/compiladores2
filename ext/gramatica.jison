...
%{
	const TIPO_OPERACION	= require('./ext/instrucciones').TIPO_OPERACION;
	const TIPO_VALOR 		= require('./ext/instrucciones').TIPO_VALOR;
	const TIPO_DATO			= require('./ext/tabla_simbolos').TIPO_DATO; //para jalar el tipo de dato
	const instruccionesAPI	= require('./ext/instrucciones').instruccionesAPI;
%}
